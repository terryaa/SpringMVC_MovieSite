      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="conplaint.jsp">민원 등록</a></li>
            </ul>
          </li>
          <li>
        ...
        *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> 민원 등록
				</h3>
				<div>
					<input type="text" class="form-control" id="member_number">
					<span class="help-block"> 등록 전 회원 번호 확인을 먼저 하여 주세요.</span>
					<button id="member_search" type="button" class="btn btn-theme02">검색</button>
				</div>
				<select class="form-control" id="complaint_number">
					<option value=1>건의</option>
					<option value=2>신고</option>
					<option value=3>문의</option>
				</select>
				<button id="register_complaint" type="button"
					class="btn btn-theme02">등록</button>
			</section>
			<!-- /wrapper -->
		</section>
		<!-- /MAIN CONTENT -->
	...
	$(document).ready(function(){
		...
		var checked=0;
		  $("#member_search").click(function(){
			    member_number=parseInt($("#member_number:text").val());
			    console.log(member_number+"membernumber");
			    if(Number.isInteger(member_number)){
			    	$.ajax({
					       url: "/MidProject/memberCheck?cmd="+member_number,
					       dataType:'json',
		  ...
		  $("#register_complaint").click(function(){
			  var member_number_new=parseInt($("#member_number:text").val());
			  if(checked==1 && member_number_new==member_number){
			  var admin_number=7;
			  var complaint_number=$('#complaint_number option:selected').val();
		    	$.ajax({
				       url: "/MidProject/complaintsRegister?cmd="
				    		   +member_number+"&admin="+admin_number
