...
<!--   <script type="text/javascript" language="javascript" src="lib/advanced-datatable/js/jquery.js"></script> -->
  ...
  $(document).ready(function(){
		...
		$.getJSON('tag_profit_se',function(data){
			console.log(data);
			for(var i = 0; i < 12; i++){
				$('#tag_profit_result').append("<div class="+"'col-lg-4 col-md-4 col-sm-4 col-xs-12'"+">"
			              +"<div class="+"'custom-box'"+">"+
                "<div class="+"'servicetitle'"+">"+
                  "<h4>태그번호 :"+data[i].tag_Table_Num+"</h4>"+"<hr>"+"</div>"+
                  "<div class="+"'icn-main-container'"+">"+
                  "<span class="+"'icn-container'"+"style="+"'height: 100px; width: 300px;''"+">"+data[i].tag_Name+"</span>"+
                  "</div>"+ "<ul class="+"'pricing'"+">"+
                  "<li>총판매액 :"+data[i].investment_sum+"</li>"+
                  "<li>평균판매액 :"+data[i].investment_avg+"</li>"+
                  "<li>해당영화수 :"+data[i].movie_count+"</li>");
			}
      ...
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>수익률 관리 페이지</h3>
            ...
            <div class="form-panel">
               	...
               	<h4>추천태그</h4>
         <div class="row">
          <div class="col-lg-12" id="tag_profit_result">
