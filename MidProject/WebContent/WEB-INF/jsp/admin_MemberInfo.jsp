				...
				<div style="width: 50%; margin-left: auto; margin-right: auto;">
					...
					<div class="modal-content">
						...
						<div class="modal-body" style="height: 500px;">
							...
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label">활성화 상태</label>
								<div class="col-sm-10">
									<input type="number" class="form-control" id="active_check_number"
										name="m_active_check_number" min="0" max="1">
								</div>
							</div>
		...
		$(function() {
			$("#search_ajax").click(
					function() {
						...
						/* $.getJSON('customerSearchData?searchType=' + searchType + "&searchName=" + searchName, function(data){
								console.log(data);
								$("#memberlist tbody").html(data);
						}); */
					});
